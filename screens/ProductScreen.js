    ...
    return (
        <View className="flex-1">
            ...
            <Image source={require('../assets/images/beansBackground2.png')} 
                ...
                style={{ height: 280, borderBottomLeftRadius: 50, borderBottomRightRadius: 50 }}
            />
            <SafeAreaView className="space-y-4">
                ...
                <View style={{ backgroundColor: themeColors.bgLight}} className="flex-row mx-4 items-center rounded-3xl p-1 px-2 space-x-1 w-16 opacity-90">
